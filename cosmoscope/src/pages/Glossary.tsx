      ...
      <div className="max-w-4xl mx-auto px-5 py-10">
        ...
        <div className="text-center mb-10">
          ...
          <p style={{ color: "rgba(255,255,255,0.4)" }}>
            Every term you'll ever need. Powered by AI for depth.
          </p>
        </div>
        ...
        {filteredTerms.length === 0 && !showCustomSearch ? (
          <div className="text-center py-16" style={{ color: "rgba(255,255,255,0.3)" }}>
            No terms match. Try the AI search above.
          </div>
        ) : (
        ...
        <p className="text-center text-xs mt-10" style={{ color: "rgba(255,255,255,0.2)" }}>
          30 featured terms · AI-powered depth for any term in the universe
        </p>
      </div>
